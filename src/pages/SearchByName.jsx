    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">Search by Name</h2>
            </div>
            ...
            <ConfirmationModal
                ...
                message={deletingProduct ? `Are you sure you want to delete "${deletingProduct.product_name}"? This action cannot be undone.` : ''}
                isDangerous={true}
            />
        </div>
    );
